...
Existe una diferencia fundamental entre construir para complacer y construir porque la cosa necesita existir. Cuando [Pieter Levels](https://twitter.com/levelsio) creó [Nomad List](https://nomadlist.com/), no lo hizo porque viera un hueco en el mercado. Lo hizo porque él necesitaba una herramienta para encontrar lugares donde vivir como nómada digital, y esa herramienta no existía. Años después, esa obsesión de una sola persona generaría millones de dólares en ingresos recurrentes. Solo. Sin empleados. Su trabajo ha sido documentado en múltiples medios como [Ars Technica](https://arstechnica.com/), [CNBC](https://www.cnbc.com/) y [Wired](https://www.wired.com/).
...
[Marc Lou](https://twitter.com/marckohlbrugge) lanzó su primer micro-SaaS y funcionó. Luego lanzó otro, y otro, y otro. Semanas entre lanzamientos. Sin marketing tradicional. Sin equipo de ventas. [Documentando todo públicamente](https://marckohlbrugge.com/) para que cualquiera pudiera ver el proceso. Lo que está haciendo Marc no es empresarismo, es manufactura. Está probando que en el mundo digital, alguien con disciplina y velocidad puede hacer lo que las grandes empresas hacen en seis meses en dos semanas.
...
[Eric Barone](https://twitter.com/ConcernedApe), conocido como ConcernedApe, se metió en un cuarto durante más de cuatro años. Dibujó cada sprite de [Stardew Valley](https://www.stardewvalley.net/). Escribió cada línea de código. Compuso cada canción del soundtrack. Solo. Cuatro años. En soledad. Ahora, [Stardew Valley tiene más de 20 millones de copias vendidas](https://www.ign.com/articles/stardew-valley-sales-milestone). Las universidades lo están estudiando. Los psicólogos lo están analizando como un fenómeno de bienestar mental.

[Markus Persson](https://twitter.com/notch) construyó [Minecraft](https://www.minecraft.net/) solo entre 2009 y 2010 hasta que ganó lo suficiente para contratar gente. Piensa en eso: un hombre, una laptop, dos años. Luego Microsoft lo compró por $2.5 mil millones de dólares. No porque Minecraft fuera un juego perfecto. Era un juego de bloques. Lo genial era que era posible de construir solo.

[Jonathan Blow](https://twitter.com/remynote) autofinanció [Braid](https://www.numbermind.com/braid/) completamente. Invirtió su propio dinero y varios años de su vida. Su éxito fue el punto de inflexión para el desarrollo independiente. Demostró que no necesitabas estar en Naughty Dog o en Rockstar Games para hacer algo que importara. Demostró que la obsesión de una sola persona podía superar la maquinaria de grandes estudios.

[Lucas Pope](https://twitter.com/dukope) trabajó en Uncharted 1 y 2 en Naughty Dog. Tenía un empleo seguro, un salario, un equipo. Lo dejó. Luego creó [Papers, Please](https://papersplease.com/). Solo. Un juego sobre inmigración donde eres un funcionario fronterizo. Ganó un BAFTA. Nadie esperaba eso. Luego hizo [Return of the Obra Dinn](https://www.dukope.com/), solo también. Dos videojuegos culturalmente significativos, hechos por una sola persona, después de haber dejado uno de los estudios más respetados del mundo.
...
[Daisuke Amaya](https://twitter.com/amayadex), conocido como Pixel, programó, ilustró, diseñó, escribió y compuso cada aspecto de [Cave Story](https://www.cavestory.org/) en su tiempo libre durante cinco años. Luego lo lanzó gratis. Gratis. Porque lo que importaba no era monetizar. Era que existiera.
...
[Jon Yongfook](https://twitter.com/yongfook) lanzó 7 productos en su reto de "12 startups en 12 meses". Luego se enfocó en [Bannerbear](https://www.bannerbear.com/), una API de generación automática de imágenes, y alcanzó $630K en ingreso recurrente anual. Piensa en la disciplina que eso requiere. Piensa en el sistema mental que necesitas tener para poder descartar seis productos fallidos y seguir adelante con la séptima idea, solo, sin que un comité venga a decirte que rindas cuentas.

[Arvid Kahl](https://twitter.com/arvidkahl) construyó [FeedbackPanda](https://www.indiehackers.com/product/feedbackpanda), la llevó a $55K mensuales, y la vendió. No necesitaba más dinero. Lo que necesitaba era seguir construyendo. Ahora [dirige una comunidad para bootstrappers](https://www.bootstrappersjourney.com/), personas que construyen sin inversión externa. Ha escrito libros. Ha dado conferencias. Todo viene de la misma lógica: que exista.
...
[Luca Galante](https://twitter.com/Poncle_), conocido como poncle, creó [Vampire Survivors](https://www.vampiresurvivors.com/). Un juego sencillo que empezó como un proyecto de $3 y se convirtió en un fenómeno. Vendió millones de copias. Creó un género completamente nuevo sin que nadie le dijera que era posible. Lo hizo porque decidió hacerlo.

[Billy Basso](https://twitter.com/bbasso_) trabajó en [Animal Well](https://www.animal-well.com/) desde 2017. Años refinando. Años puliendo. Años sin saber si alguien lo iba a jugar. En 2024 se convirtió en uno de los juegos más comentados del año. Un puzzle-platformer visualmente único. Hecho por una sola persona. Años de trabajo. Soledad. Y luego, reconocimiento.
...
[Pieter Levels mencionó en una entrevista](https://www.youtube.com/watch?v=vwz6R1iWJ_Q) que después de ganar sus primeros millones, nada cambió. Seguía trabajando igual. Seguía construyendo igual. Porque el dinero no era el punto. El punto era siempre la construcción en sí. El dinero era solo la métrica de que alguien más lo consideraba valioso.
...
La mayoría de startups fracasa no porque [la idea sea mala](https://www.cnbc.com/2025/03/15/why-startups-fail-study/). Fracasa porque hay demasiadas personas en la sala con demasiadas opiniones diferentes. Los soloentrepreneurs no tienen ese problema. Tienen un problema distinto: están completamente solos si todo falla.
...
Existe una razón por la que los indie hackers son cada vez más visibles. No es porque [la IA los haya ayudado](https://www.wired.com/story/ai-helping-solo-entrepreneurs/) (aunque la IA definitivamente ayuda). No es porque internet sea mejor hoy (la infraestructura siempre mejora). Es porque cada año, el soloentrepreneur demuestra que puede hacer más con menos.
...
- [Indie Hackers — Comunidad de Startups Bootstrap](https://www.indiehackers.com/)
- [Pieter Levels - Nomad List](https://nomadlist.com/)
- [Pieter Levels - Remote OK](https://remoteok.com/)
- [Marc Lou - Multiple Micro-SaaS Projects](https://marckohlbrugge.com/)
- [Carrd - Simple Site Builder](https://carrd.co/)
- [Danny Postma - HeadshotPro](https://www.headshotpro.com/)
- [Jon Yongfook - Bannerbear](https://www.bannerbear.com/)
- [Arvid Kahl - FeedbackPanda & Bootstrapper's Journey](https://www.bootstrappersjourney.com/)
- [David Bressler - Formula Bot](https://formulabot.com/)
- [Ania Kubów - Rootd Mental Health App](https://www.rootd.app/)
- [Eric Barone (ConcernedApe) - Stardew Valley](https://www.stardewvalley.net/)
- [Stardew Valley Sales Milestone — IGN](https://www.ign.com/articles/stardew-valley-sales-milestone)
- [Markus Persson (Notch) - Minecraft](https://www.minecraft.net/)
- [Jonathan Blow - Braid](https://www.numbermind.com/braid/)
- [Lucas Pope - Papers, Please](https://papersplease.com/)
- [Lucas Pope - Return of the Obra Dinn](https://www.dukope.com/)
- [Daisuke Amaya (Pixel) - Cave Story](https://www.cavestory.org/)
- [Luca Galante (poncle) - Vampire Survivors](https://www.vampiresurvivors.com/)
- [LocalThunk - Balatro](https://www.balatro.net/)
- [Billy Basso - Animal Well](https://www.animal-well.com/)
- [CNBC — Why Startups Fail Study](https://www.cnbc.com/2025/03/15/why-startups-fail-study/)
- [Ars Technica — Indie Game Development](https://arstechnica.com/)
- [Wired — AI Helping Solo Entrepreneurs](https://www.wired.com/story/ai-helping-solo-entrepreneurs/)
- [YouTube — Pieter Levels Interview](https://www.youtube.com/watch?v=vwz6R1iWJ_Q)
